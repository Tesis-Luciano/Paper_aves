...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.95\linewidth]{N_r.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.48\linewidth]{Circular distribution.png}
    \includegraphics[width=0.48\linewidth]{VR1 distribution.png}
    \includegraphics[width=0.48\linewidth]{VR3 distribution.png}
    \includegraphics[width=0.48\linewidth]{VR10 distribution.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.95\linewidth]{L(N).png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.95\linewidth]{A(n).png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.95\linewidth]{Frequency P_base-5.png}
    \includegraphics[width=0.95\linewidth]{Frequency P_base-7.png}
